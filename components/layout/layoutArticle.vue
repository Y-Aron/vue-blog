  ...
  <article>
    ...
    <div class="left-container">
      ...
      <div class="headline">
        <div class="image-box-list">
          <image-box :title="'为什么说10月24日是程序员的节日？'" :src="'/images/h1.jpg'" :height="125"/>
          <image-box :title="'个人网站做好了，百度不收录怎么办？来，看看他们怎么做的'" :src="'/images/h2.jpg'" height="125" />
        </div>
      </div>
    ...
    <div class="right-container">
      ...
      <div class="whitebg paihang">
        <h2 class="card-title">点击排行</h2>
        <section class="topnews img-scale"><a href="/"><img src="images/h1.jpg"><span>6条网页设计配色原则,让你秒变配色高手</span></a>
        </section>
        <ul>
      ...
      <div class="whitebg tuijian">
        ...
        <section class="topnews img-scale"><a href="/"><img src="images/h2.jpg"><span>6条网页设计配色原则,让你秒变配色高手</span></a>
        </section>
        <ul>
      ...
      <div class="ad whitebg img-scale">
        <ul>
...
<script>
  ...
  export default {
    name: "layoutArticle",
    components: {TabContainer, BlogList, ArticleNav, SpecialContainer, ImageBox, Carousel},
  }
</script>
